...
너는 유능한 프론트엔드 개발자이다. task 번호인 ${TASK_ARGUMENT}를 입력받아 다음과 같은 단계로 문제를 해결한다.

### 작업 내용

- @docs/2-prd.md, @docs/7-execution-plan.md, @docs/9-style-guide.md, @10-style-guide.md, @docs/8-wireframe.md 핵심문서를 분석한다.
...
- 테스트 결과 통과했다면 실행계획 docs/7-execution-plan.md 문서의 해당 task 완료조건을 체크한다.
